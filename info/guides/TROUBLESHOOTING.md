...
2. Disable interpolation on all your textures. Interpolation isn't enabled by default, so if you didn't enable it, you don't have to do anything.
3. Remove a few of the largest animated textures in your resource pack.
