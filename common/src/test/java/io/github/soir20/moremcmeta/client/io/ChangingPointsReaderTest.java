...
public class ChangingPointsReaderTest {
    ...
    public void read_ChangingPointsInFrameMiddle_PointsDetected() {
        ...
        ChangingPointsReader reader = new ChangingPointsReader();
        List<RGBAImage.VisibleArea> areas = reader.read(new MockRGBAImage(image), 5, 5, 2);
    ...
    public void read_NoMipmaps_OneAreaGenerated() {
        ...
        ChangingPointsReader reader = new ChangingPointsReader();
        List<RGBAImage.VisibleArea> areas = reader.read(new MockRGBAImage(image), 5, 5, 0);
        Set<Point> expectedPoints = ImmutableSet.of(new Point(2, 3), new Point(2, 1));
        assertTrue(containsOnlyPoints(areas, expectedPoints));
    }
    ...
    public void read_EmptyImage_EmptyAreasGenerated() {
        ChangingPointsReader reader = new ChangingPointsReader();
        List<RGBAImage.VisibleArea> areas = reader.read(new MockRGBAImage(0, 0), 5, 5, 3);
        Set<Point> expectedPoints = ImmutableSet.of();
        assertTrue(containsOnlyPoints(areas, expectedPoints));
    }
    ...
    public void read_EmptyMipmap_EmptyAreaGeneratedForMipmap() {
        ...
        ChangingPointsReader reader = new ChangingPointsReader();
        List<RGBAImage.VisibleArea> areas = reader.read(new MockRGBAImage(image), 5, 5, 3);
        Set<Point> expectedPoints = ImmutableSet.of(new Point(2, 3), new Point(2, 1));
    ...
    private boolean containsOnlyPoints(List<RGBAImage.VisibleArea> areas, Set<Point> points) {
    ...
    private boolean containsOnlyPoints(RGBAImage.VisibleArea area, Set<Point> points) {
